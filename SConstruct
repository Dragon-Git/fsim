...
Runs all three SConstruct.<vendor>.py files in parallel using the num_jobs option.
...
SConscript('SConstruct.cadence.py')
SConscript('SConstruct.mentor.py')
SConscript('SConstruct.synopsys.py')
